...
<div class="container" style="width: 100%">
      ...
      <div class="row"><h1 class="page-header" style="text-align: center; margin-bottom: 50px;"></h1>
         <input type="hidden" value="friut" id="product">
      </div>
      <div class="row" style="float: left; text-align: center; width:35%; margin-left:100px;">
         <img src="img/fruit.jpeg" style="width: 130%">
      </div>

      <div class="row productInfo" style="width: 40%; float: right;" >
         <div class="form-group" style="text-align: left;">
            <div class="product_name">Fruit</div>
            <input type="hidden" value="fruit" name="product">
         	</div>
         <br>
         <div class="form-group" style="text-align: left;">
      ...
      <div style="text-align: center; margin: 80px 0;">
	   ...
	   <table class="recommend" border=0>
	      ...
	      <col width="25%">
	         ...
	         <tr align="center">
	            <td><a href="pastaindex.jsp"><img src="img/pasta.jpeg" width="200px"></a></td>
	            <td><a href="sangyeon94index.jsp"><img src="img/sangyeon94.jpeg" width="200px"></a></td>
	            <td><a href="yongwoo21index.jsp"><img src="img/yongwoo21.jpeg" width="200px"></a></td>
	         </tr>
	         
	         <tr align="center">
	            <td ><a href="pastaindex.jsp"><b>파스타</b></a></td>
	            <td ><a href="sangyeon94index.jsp"><b>Sangyeon94</b></a></td>
	            <td ><a href="yongwoo21index.jsp"><b>Yongwoo21</b></a></td>
	         </tr>
	         <tr align="center">
	            <td ><b>30원</b></td>
	            <td ><b>350원</b></td>
